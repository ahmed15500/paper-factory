...
const translations = {
  ar: {
    ...
    heroImageAlt: "ماكينات قص وتحويل الورق داخل مصنع حديث", aboutImageAlt: "فريق التشغيل يراجع عملية تحويل الورق داخل المصنع", servicesImageAlt: "ماكينة دقيقة لقص وتحويل الورق إلى أفرخ", finishedImageAlt: "أفرخ ورقية جاهزة ومنظمة على منصات داخل المصنع",
    ...
    servicesPhotoTitle: "تجهيز دقيق من الرول إلى الفرخ", servicesPhotoText: "معدات متخصصة لتنفيذ المقاسات المطلوبة وتنظيم المنتج النهائي.",
    ...
    finishedEyebrow: "المنتج النهائي", finishedTitle: "أفرخ ورقية مجهزة ومنظمة وجاهزة للطلب", finishedCta: "أرسل مواصفاتك",
  ...
  en: {
    ...
    heroImageAlt: "Modern paper cutting and converting machinery inside the factory", aboutImageAlt: "Factory operations team inspecting the paper converting process", servicesImageAlt: "Precision machine cutting and converting paper into sheets", finishedImageAlt: "Organized finished paper sheets ready for delivery",
    ...
    servicesPhotoTitle: "Precision preparation from roll to sheet", servicesPhotoText: "Specialized equipment for requested dimensions and organized finished output.",
    ...
    finishedEyebrow: "Finished output", finishedTitle: "Prepared and organized paper sheets ready for your order", finishedCta: "Send your specifications",
